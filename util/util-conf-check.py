...
#    'used_added' : []                           # Список объектов, которые нужно добавить к использованным
#}
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(prog = 'util-conf-check',
                                        description = desprg,
                                        add_help = False,
